         ...
         <div className={styles.EmailIntegrationCardsinner}>
             <div className={styles.EmailIntegrationCardsmainbox}>
                ...
                <div className={styles.EmailIntegrationCardsimage}>
                    <div>
                    <Image
          src={"https://d3op2l77j7wnti.cloudfront.net/Images/EmailIntegrationphotos/bannerr (13).webp"}
          alt={"image"}
          width={"0"}
          height={"0"}
          sizes={"100vw"}
...
Using workflow templates, you can enable a workflow by simply clicking a button or can edit an existing template to add more conditions and make it live.</p>
                ...
                <div className={styles.EmailIntegrationCardsimage}>
                    <div>
                    <Image
          src={"https://d3op2l77j7wnti.cloudfront.net/Images/EmailIntegrationphotos/bannerr (14).webp"}
          alt={"image"}
          width={"0"}
          height={"0"}
          sizes={"100vw"}
        ...
        /> 
             ...
             <div className={styles.EmailIntegrationCardsmainbox1}>
                ...
                <div className={styles.EmailIntegrationCardsimage}>
                    <div>
                    <Image
          src={"https://d3op2l77j7wnti.cloudfront.net/Images/EmailIntegrationphotos/bannerr (16).webp"}
          alt={"image"}
          width={"0"}
          height={"0"}
          sizes={"100vw"}
        ...
        /> 
             ...
             <div className={styles.EmailIntegrationCardsmainbox1}>
                ...
                <div className={styles.EmailIntegrationCardsimage}>
                    <div>
                    <Image
          src={"https://d3op2l77j7wnti.cloudfront.net/Images/EmailIntegrationphotos/bannerr (15).webp"}
          alt={"image"}
          width={"0"}
          height={"0"}
          sizes={"100vw"}
