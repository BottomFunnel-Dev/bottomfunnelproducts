    ...
    <div>
        ...
        <div className={styles.FinancialServicemaindivinner}>
            ...
            <Image
                ...
                <p>“We’re using Freshchat to solve our customers’ needs with precision, and in real-time. It has ensured our customers receive prompt personalized experiences and has also brought in operational efficiencies that make assisted buying extremely scalable.”</p>
...
<button className={styles.FinancialServicemaindivsecondbutton}>Sing Up For Free</button>
        </div>
    </div>
  )
}
