    ...
    <div className={style.Financepragrafmaindiv} >
      ...
      <div className={style.Financepragrafinnerdivsecond}>
        <div className={style.Financepragrafinnerdivsecondinner}>
          ...
          <div>
            <h2>Why do you need a specialized CRM for Finance?</h2>
          </div>
        </div>

        <div className={style.Financepragrafinnerdivsecondcontent}>
          <p>
            Well, the reasons are many. Whether you run a wealth management firm, commercial bank, corporate bank, or investment
            bank, a modern CRM for Finance ensures that your employees across sales, marketing, and support teams can access
            customer data and customer activity history seamlessly across departments. This is the first step to enhancing
            customer experience. Of course, a CRM software for Finance also ensures that you don’t have to juggle between
            multiple tools to manage the customer journey and customer data. The CRM offers everything finance teams need on
            one single platform.
          </p>
        </div>
      </div>
