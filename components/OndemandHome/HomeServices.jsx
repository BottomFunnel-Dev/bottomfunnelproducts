...
const HomeServices = () => {
  ...
  const homeService = [
    {
      serviceimage: "https://bottom-funnel-product.s3.ap-south-1.amazonaws.com/Images/ondemandHome/carpenter.png",
      serviceDescription:
        "Get more business with customized on-demand carpenter services. Carpenters across the city are waiting for you!",
      serviceName: "Carpenter",
    },
    {
      serviceimage: "https://bottom-funnel-product.s3.ap-south-1.amazonaws.com/Images/ondemandHome/cleaning.png",
      serviceDescription:
        "Increase profits and grow your business with customizable, on-demand home services of cleaning through an App",
      serviceName: "Cleaning",
    },
    {
      serviceimage: "https://bottom-funnel-product.s3.ap-south-1.amazonaws.com/Images/ondemandHome/washing.png",
      serviceDescription:
    ...
    {
      serviceimage: "https://bottom-funnel-product.s3.ap-south-1.amazonaws.com/Images/ondemandHome/childcare.png",
      serviceDescription:
    ...
    {
      serviceimage: "https://bottom-funnel-product.s3.ap-south-1.amazonaws.com/Images/ondemandHome/electrical.png",
      serviceDescription:
    ...
    {
      serviceimage: "https://bottom-funnel-product.s3.ap-south-1.amazonaws.com/Images/ondemandHome/painting.png",
      serviceDescription:
        "Transform your business with customized on demand home services by your painters through this app.",
      serviceName: "Painting service",
    },
    {
      serviceimage: "https://bottom-funnel-product.s3.ap-south-1.amazonaws.com/Images/ondemandHome/plumbing.png",
      serviceDescription:
