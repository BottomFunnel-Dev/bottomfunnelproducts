      ...
      <div className={styles.customerApp}>
        ...
        <div className={styles.customerImages}>
          ...
          <div className={styles.backfeature}>
            <img src="https://d3op2l77j7wnti.cloudfront.net/Images/ondemandHome/shape1.png" alt="images" />
          </div>

          <div className={styles.customerphone}>
            <img src="https://d3op2l77j7wnti.cloudfront.net/Images/ondemandHome/customerapp.png" alt="images" />
          </div>
        </div>
      ...
      <div className={styles.adminpanel}>
        ...
        <div className={styles.adminImage}>
          <div className={styles.backadmin}>
            <img src="https://d3op2l77j7wnti.cloudfront.net/Images/ondemandHome/shape2.png" alt="images" />
          </div>
          <div className={styles.backadmindown}>
            <img src="https://d3op2l77j7wnti.cloudfront.net/Images/ondemandHome/shape2.png" alt="images" />
          </div>
          <div className={styles.adminpanelimage}>
            <img src="https://d3op2l77j7wnti.cloudfront.net/Images/ondemandHome/adminpanel.png" alt="images" />
          </div>
        </div>
      </div>
      ...
      <div className={styles.serviceApp}>
        <div className={styles.serviceImage}>
          <div className={styles.serviceappback}>
            <img src="https://d3op2l77j7wnti.cloudfront.net/Images/ondemandHome/shape3.png" alt="images" />
          </div>
          <div className={styles.serviceappmobile}>
            <img src="https://d3op2l77j7wnti.cloudfront.net/Images/ondemandHome/serviceproviderpanel.png" alt="images" />
          </div>
        </div>
      ...
      <div className={styles.serviceproviderpanel}>
        ...
        <div className={styles.serviceProviderImage}>
          <div className={styles.serviceproviderback}>
            <img src="https://d3op2l77j7wnti.cloudfront.net/Images/ondemandHome/shape4.png" alt="images" />
          </div>
