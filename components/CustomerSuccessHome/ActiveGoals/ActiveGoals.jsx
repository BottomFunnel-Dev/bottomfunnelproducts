            ...
            <div className={styles.ActiveGoalsmaindivcards}>
                <div className={styles.ActiveGoalsmaindivcardsdiv}>
                    <div className={styles.ActiveGoalsmaindivcardsdivinner}>
                        ...
                        <div>
                            <img src="https://d3op2l77j7wnti.cloudfront.net/Images/customersuccesshomepagephotos/logo1.png" alt="image" />
                        </div>
                    ...
                    <div className={styles.ActiveGoalsmaindivcardsdivinner}>
                        <h5>Increase up-sells and expansions</h5>
                        <div>
                            <img src="https://d3op2l77j7wnti.cloudfront.net/Images/customersuccesshomepagephotos/logo2.png" alt="image" />
                        </div>
                    ...
                    <div className={styles.ActiveGoalsmaindivcardsdivinner}>
                        ...
                        <div>
                            <img src="https://d3op2l77j7wnti.cloudfront.net/Images/customersuccesshomepagephotos/logo3.png" alt="image" />
                        </div>
