    ...
    <div>
      <div className={style.TrySalesCrmmaindiv}>
        <div className={style.TrySalesCrmcontaindiv}>
          ...
          <p>
            Bottom Funnel Sales is a leading CRM built for sales teams in SaaS businesses geared to improve customer experiences,
            sell more, and increase productivity. Your search for a CRM ends here. Sign up for a 21-day free trial and see how
            you can grow your SaaS business organically.
          </p>
