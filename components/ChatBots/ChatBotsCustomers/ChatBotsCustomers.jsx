        ...
        <div className={styles.chatbotscustomersparent}>
            ...
            <div className={styles.chatbotscustomersparentfirstchild}>
                <div className={styles.chatbotcustoemrscontent}>
                    <h2 className={styles.hfontwiegth}>Delight, not just deflect
                    </h2>
                    <p>
                        Build bots that can detect intent, define its
                        conversations using the powerful no-code builder.
                        Setup flows to guide your customers through a
                        step-by-step troubleshooting process to fully
                ...
                <div className={styles.chatbotcustoemrsimage}>
                    <Image
                        src={"/Images/ChatBots/imageone.webp"}
                        alt={"img"}
                        width={"0"}
                        height={"0"}
                        sizes={"100vw"}
