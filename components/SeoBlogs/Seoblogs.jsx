      ...
      <div className={styles._Seoblogs}>
        <div className={styles._Seoblogs1}>
          <div className={styles._Seoblogsimage}>
            <img src="/Images/blogSection/stories1.png" alt="images" />
          </div>
        ...
        <div className={styles._Seoblogs1}>
          <div className={styles._Seoblogsimage}>
            <img src="/Images/blogSection/stories2.png" alt="images" />
          </div>
          <div className={styles._Seoblogstext}>
        ...
        <div className={styles._Seoblogs1}>
          <div className={styles._Seoblogsimage}>
            <img src="/Images/blogSection/stories4.png" alt="images" />
          </div>
          <div className={styles._Seoblogstext}>
