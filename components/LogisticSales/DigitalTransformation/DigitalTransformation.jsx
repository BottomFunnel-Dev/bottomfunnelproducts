...
export const DigitalTransformation = () => {
    const data = [
        {
        img:"/Images/Logisticsalesphotos/logo1.png",
        ...
        {
        img:"/Images/Logisticsalesphotos/logo2.png",
        hd:"New market entrants and new business models",
        p:"Closely linked to the digital disruptions in the industry, the sub-segment of logistics which is facing high competition is 3PL providers. As much as they are on demand, there’s also a slew of new market entrants with better technologies fighting for a share of the market."
        },
        {
        img:"/Images/Logisticsalesphotos/logo3.png",
        hd:"Changing customer expectations",
