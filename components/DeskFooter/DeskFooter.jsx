            ...
            <div className={styles.desksFooterContentMainDiv}>
                <div className={styles.desksFooterTagsDiv}>
                    ...
                    <ul className={styles.deskMaindeskDivLink}>
                        ...
                        <Link className={styles.deskFooterLinkTag} href={"/funneldesk/features/ticketing"}>
                            <li> Ticketing </li>
                        </Link>

                        <Link className={styles.deskFooterLinkTag} href={"/funneldesk/features/collaboration"}>
                            <li> Collaboration </li>
                        </Link>

                        <Link className={styles.deskFooterLinkTag} href={"/bottomfunnel-omnichannel"}>
                            <li> Omnichannel HelpDesk </li>
                        </Link>

                        <Link className={styles.deskFooterLinkTag} href={"/funneldesk/features/automation"}>
                            <li> Automations </li>
                        </Link>

                        <Link className={styles.deskFooterLinkTag} href={"/funneldesk/solutions/selfservice"}>
                            <li> Self Service </li>
                        </Link>

                        <Link className={styles.deskFooterLinkTag} href={"/funneldesk/solutions/fieldservicemanagement"}>
                            <li> Field Service Management </li>
                        </Link>

                        <Link className={styles.deskFooterLinkTag} href={"/funneldesk/features/reportandanalysis"}>
                    ...
                    <ul className={styles.deskMaindeskDivLink}>
                        ...
                        <Link className={styles.deskFooterLinkTag} href={"funneldesk/solutions/enterprise"}>
                            <li>
                                Enterprise
                            </li>
                        </Link>

                        <Link className={styles.deskFooterLinkTag} href={"funneldesk/solutions/smb"}>
                            <li>
                                SMB
                            </li>
                        </Link>
