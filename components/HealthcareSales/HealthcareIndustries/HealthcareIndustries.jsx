...
<div className={styles.HealthcareIndustriesmaindiv}>
           ...
           <div className={styles.HealthcareIndustriesmaindivinnerdiv}>
             <div className={styles.HealthcareIndustriesmaindivinnerdivcell}>
                ...
                <Image
                        src={"https://d3op2l77j7wnti.cloudfront.net/Images/healthcaresales/collection1.webp"}
                        alt={"img"}
                        width={"0"}
                        height={"0"}
                        sizes={"100vw"}
             ...
             <div className={styles.HealthcareIndustriesmaindivinnerdivcell}>
                <div className={styles.HealthcareIndustriesmaindivimage}>
                <Image
                        src={"https://d3op2l77j7wnti.cloudfront.net/Images/healthcaresales/collection2.webp"}
                        alt={"img"}
                        width={"0"}
                        height={"0"}
                        sizes={"100vw"}
             ...
             <div className={styles.HealthcareIndustriesmaindivinnerdivcell}>
                <div className={styles.HealthcareIndustriesmaindivimage}>
                <Image
                        src={"https://d3op2l77j7wnti.cloudfront.net/Images/healthcaresales/collection3.webp"}
                        alt={"img"}
                        width={"0"}
                        height={"0"}
                        sizes={"100vw"}
