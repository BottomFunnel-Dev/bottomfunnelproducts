        ...
        <div className={styles.ContentMarketingServicesExpertiseParent}>
            ...
            <div className={styles.ContentMarketingServicesExpertiseParentonlyChild}>
                <div className={styles.ContentMarketingServicesExpertiseParentonlyChildFirstChild}>
                    <div>
                        <div> <Image
                            src={"/Images/ContentMarketingServices/Expertise1.webp"}
                            alt={"image"}
                            width={"0"}
                            height={"0"}
                            sizes={"100vw"}
                    ...
                    <div  className={styles.ContentMarketingServicesExpertiseParentborder}>
                        <div><Image
                            src={"/Images/ContentMarketingServices/Expertise2.webp"}
                            alt={"image"}
                            width={"0"}
                            height={"0"}
                            sizes={"100vw"}
                    ...
                    <div>
                        <div><Image
                            src={"/Images/ContentMarketingServices/Expertise3.webp"}
                            alt={"image"}
                            width={"0"}
                            height={"0"}
                            sizes={"100vw"}
                ...
                <div className={styles.ContentMarketingServicesExpertiseParentonlyChildSecChild}>
                    <div>
                        <div><Image
                            src={"/Images/ContentMarketingServices/Expertise4.webp"}
                            alt={"image"}
                            width={"0"}
                            height={"0"}
                            sizes={"100vw"}
                    ...
                    <div className={styles.ContentMarketingServicesExpertiseParentborder}>
                        <div><Image
                            src={"/Images/ContentMarketingServices/Expertise5.webp"}
                            alt={"image"}
                            width={"0"}
                            height={"0"}
                            sizes={"100vw"}
                    ...
                    <div>
                        <div><Image
                            src={"/Images/ContentMarketingServices/Expertise6.webp"}
                            alt={"image"}
                            width={"0"}
                            height={"0"}
                            sizes={"100vw"}
