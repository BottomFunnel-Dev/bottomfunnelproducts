        ...
        <div className={styles.bankingFinanceContainer}>
             ...
             <div className={styles.bankingFinanceBox}>
                ...
                <div className={styles.bankingFinanceImages}>
                    <Image
                        src={"https://d3op2l77j7wnti.cloudfront.net/Images/bankingandfinance/Rectangle4.png"}
                        alt={"img"}
                        width={"0"}
                        height={"0"}
                        sizes={"100vw"}
             ...
             <div className={styles.bankingFinanceBox}>
                ...
                <div className={styles.bankingFinanceImages}>
                    <Image
                        src={"https://d3op2l77j7wnti.cloudfront.net/Images/bankingandfinance/Rectangle5.png"}
                        alt={"img"}
                        width={"0"}
                        height={"0"}
                        sizes={"100vw"}
             ...
             <div className={styles.bankingFinanceBox}>
                ...
                <div className={styles.bankingFinanceImages}>
                    <Image
                        src={"https://d3op2l77j7wnti.cloudfront.net/Images/bankingandfinance/Rectangle3.png"}
                        alt={"img"}
                        width={"0"}
                        height={"0"}
                        sizes={"100vw"}
