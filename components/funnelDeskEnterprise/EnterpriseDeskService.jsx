    ...
    <div className={styles.deskService}>
      <div className={styles.enterpriseDeskService}>
        ...
        <div className={styles.enterpriseGifSide}>
            <lottie-player
                src={"https://d3op2l77j7wnti.cloudfront.net/Animation/Enterprise/Comp1.json"}
      ...
      <div className={styles.enterpriseDeskServiceReverse}>
        ...
        <div className={styles.enterpriseGifSide}>
           <lottie-player
                src={"https://d3op2l77j7wnti.cloudfront.net/Animation/Enterprise/Comp2.json"}
                background="transparent"
                speed="1"
                loop
                autoplay
      ...
      <div className={styles.enterpriseDeskService}>
        ...
        <div className={styles.enterpriseGifSide}>
            <lottie-player
                src={"https://d3op2l77j7wnti.cloudfront.net/Animation/Enterprise/Comp3.json"}
                background="transparent"
                speed="1"
                loop
                autoplay
      ...
      <div className={styles.enterpriseDeskServiceReverse}>
        ...
        <div className={styles.enterpriseGifSide}>
           <lottie-player
                src={"https://d3op2l77j7wnti.cloudfront.net/Animation/Enterprise/Comp4.json"}
                background="transparent"
                speed="1"
                loop
                autoplay
      ...
      <div className={styles.enterpriseDeskService}>
        ...
        <div className={styles.enterpriseGifSide}>
           <lottie-player
                src={"https://d3op2l77j7wnti.cloudfront.net/Animation/Enterprise/Comp5.json"}
                background="transparent"
                speed="1"
                loop
                autoplay
      ...
      <div className={styles.enterpriseDeskServiceReverse}>
        ...
        <div className={styles.enterpriseGifSide}>
            <lottie-player
                src={"https://d3op2l77j7wnti.cloudfront.net/Animation/Enterprise/Comp6.json"}
                background="transparent"
                speed="1"
                loop
                autoplay
