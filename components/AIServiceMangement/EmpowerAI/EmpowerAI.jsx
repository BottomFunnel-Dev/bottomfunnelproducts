    ...
    <div>
     ...
     <div className={styles.EmpowerAImaindiv}>
        <div className={styles.EmpowerAImaindivinner}>
            ...
            <p>Enable self-service on any channel. Quickly get answers and insights to measure and improve customer satisfaction</p>
        </div>
        ...
        <div className={styles.EmpowerAImaindivinner}>
            ...
            <h5>Increase agent productivity</h5>
            <p>Ease your agent’s workload and improve their productivity by solving issues quickly at scale with machine learning based intelligent and relevant recommendations</p>
        </div>
        ...
        <div className={styles.EmpowerAImaindivinner}>
            ...
            <p>Reduce handling time significantly by automatically categorizing, prioritizing and routing tickets</p>
        </div>
     </div>
    </div>
  )
