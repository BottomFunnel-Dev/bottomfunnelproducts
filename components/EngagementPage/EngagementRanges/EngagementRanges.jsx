  ...
  const cardsData = [
    {
      ...
      icons: "https://d3op2l77j7wnti.cloudfront.net/Images/engagementPhotos/light.png",
    },
    {
      ...
      icons: "https://d3op2l77j7wnti.cloudfront.net/Images/engagementPhotos/stopwatch.png",
    },
    {
      title: "HOURLY HIRE",
      ...
      icons: "https://d3op2l77j7wnti.cloudfront.net/Images/engagementPhotos/clock.png",
    },
  ];
  ...
  return (
    <div className={styles.engagementRangesContainer}>
      ...
      <div className={styles.engagementRangesMain}>
        ...
        <div>
          <img src="https://d3op2l77j7wnti.cloudfront.net/Images/engagementPhotos/greeting.png" alt="greeting.png" />
        </div>
      ...
      <div className={styles.engagementRangesMain}>
        <div>
          <img src="https://d3op2l77j7wnti.cloudfront.net/Images/engagementPhotos/phone.png" alt="phone.png" />
        </div>
