...
<div className={styles.ResolutionWaymaindivcards } >
    <div className={styles.ResolutionWaymaindivcardsbox}>
     ...
     <Image
                        src={"https://d3op2l77j7wnti.cloudfront.net/Images/contactresolutionphotos/increase 1.webp"}
                        alt={"img"}
                        width={"0"}
                        height={"0"}
                        sizes={"100vw"}
    ...
    <div className={styles.ResolutionWaymaindivcardsbox}>
     ...
     <div className={styles.ResolutionWaymaindivcardsboximage}>
     <Image
                        src={"https://d3op2l77j7wnti.cloudfront.net/Images/contactresolutionphotos/increase 1 (1).webp"}
                        alt={"img"}
                        width={"0"}
                        height={"0"}
                        sizes={"100vw"}
    ...
    <div className={styles.ResolutionWaymaindivcardsbox} style={{border:"none"}}>
     ...
     <div className={styles.ResolutionWaymaindivcardsboximage}>
     <Image
                        src={"https://d3op2l77j7wnti.cloudfront.net/Images/contactresolutionphotos/increase 1 (2).webp"}
                        alt={"img"}
                        width={"0"}
                        height={"0"}
                        sizes={"100vw"}
...
<div className={styles.ResolutionWaymaindivcards} style={{border:"none"}}>
    <div className={styles.ResolutionWaymaindivcardsbox}>
     ...
     <div className={styles.ResolutionWaymaindivcardsboximage}>
     <Image
                        src={"https://d3op2l77j7wnti.cloudfront.net/Images/contactresolutionphotos/increase 1 (3).webp"}
                        alt={"img"}
                        width={"0"}
                        height={"0"}
                        sizes={"100vw"}
    ...
    <div className={styles.ResolutionWaymaindivcardsbox} style={{border:"none"}}>
     ...
     <div className={styles.ResolutionWaymaindivcardsboximage}>
     <Image
                        src={"https://d3op2l77j7wnti.cloudfront.net/Images/contactresolutionphotos/increase 1 (4).webp"}
                        alt={"img"}
                        width={"0"}
                        height={"0"}
                        sizes={"100vw"}
