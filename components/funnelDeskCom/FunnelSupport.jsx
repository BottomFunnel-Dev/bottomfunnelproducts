  ...
  return (
    <div className={styles.supportDesk}>
      ...
      <div className={styles.deskImage}>
        <img
          src="https://d3op2l77j7wnti.cloudfront.net/Images/BottomFunnelDeskPhotos/point-1.png"
          alt="BottomFunnelDeskPhotos/point-1.png"
        />
        <img
          src="https://d3op2l77j7wnti.cloudfront.net/Images/BottomFunnelDeskPhotos/point-2.png"
          alt="BottomFunnelDeskPhotos/point-2.png"
        />
        <img
          src="https://d3op2l77j7wnti.cloudfront.net/Images/BottomFunnelDeskPhotos/point-3.png"
