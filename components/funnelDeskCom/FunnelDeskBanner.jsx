  ...
  return (
    <div className={styles.funnelSupport}>
      <div className={styles.bannerBackImgLeft}>
        <img src="https://d3op2l77j7wnti.cloudfront.net/Images/BottomFunnelDeskPhotos/wires.png" alt="" />
      </div>
      <div className={styles.mainContentBanner}>
        <div className={styles.imagePart}>
          <img src="https://d3op2l77j7wnti.cloudfront.net/Images/BottomFunnelDeskPhotos/human.png" alt="human" />
        </div>
