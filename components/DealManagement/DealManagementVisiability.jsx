    ...
    const dealmanagementvisibilitydata = [
        {
            ...
            icon:"/Images/Deal management/icons/ha/money-management 1.webp",
        },

        {
            ...
            icon:"/Images/Deal management/icons/ha/achievement 1.webp",
        },
...

        {
            ...
            icon:"/Images/Deal management/icons/ha/approve 1.webp",
        },
...

        {
            ...
            icon:"/Images/Deal management/icons/ha/Vector.webp",
        },
...

        {
            ...
            icon:"/Images/Deal management/icons/ha/revenue 1.webp",
        },
