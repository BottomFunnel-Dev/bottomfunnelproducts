    ...
    const dealmanagementvisibilitydata = [
        {
            ...
            icon:"https://bottom-funnel-product.s3.ap-south-1.amazonaws.com/Images/Deal management/icons/ha/money-management 1.webp",
        },

        {
            ...
            icon:"https://bottom-funnel-product.s3.ap-south-1.amazonaws.com/Images/Deal management/icons/ha/achievement 1.webp",
        },
...

        {
            ...
            icon:"https://bottom-funnel-product.s3.ap-south-1.amazonaws.com/Images/Deal management/icons/ha/approve 1.webp",
        },
...

        {
            ...
            icon:"https://bottom-funnel-product.s3.ap-south-1.amazonaws.com/Images/Deal management/icons/ha/Vector.webp",
        },
...

        {
            ...
            icon:"https://bottom-funnel-product.s3.ap-south-1.amazonaws.com/Images/Deal management/icons/ha/revenue 1.webp",
        },
