...
export const PipelineManagement = () => {
  return (
   ...
   <Image
          src={"https://d3op2l77j7wnti.cloudfront.net/Images/Deal management/banners & background/ha/Group 1000003851.webp"}
          alt={"images"}
          width={"0"}
          height={"0"}
          sizes={"100vw"}
...
        />
   ...
   <Image
   src={"https://d3op2l77j7wnti.cloudfront.net/Images/Deal management/Screens/ha/accelerate sales.webp"}
   alt={"images"}
   width={"0"}
   height={"0"}
   sizes={"100vw"}
