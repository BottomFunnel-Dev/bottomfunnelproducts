        ...
        <div className={styles.ManufacturingCrmmaindivrowbox}>
          <div className={styles.ManufacturingCrmmaindivrowboxdiv}>
            <div className={styles.ManufacturingCrmmaindivrowboxdivimage}>
              <Image
                src={"https://d3op2l77j7wnti.cloudfront.net/Images/Manufacturing/tap 1.png"}
                alt={"img"}
                width={"0"}
                height={"0"}
                sizes={"100vw"}
          ...
          <div className={styles.ManufacturingCrmmaindivrowboxdiv}>
            <div className={styles.ManufacturingCrmmaindivrowboxdivimage}>
              <Image
                src={"https://d3op2l77j7wnti.cloudfront.net/Images/Manufacturing/ai 1.png"}
                alt={"img"}
                width={"0"}
                height={"0"}
                sizes={"100vw"}
          ...
          <div className={styles.ManufacturingCrmmaindivrowboxdiv}>
            <div className={styles.ManufacturingCrmmaindivrowboxdivimage}>
              <Image
                src={"https://d3op2l77j7wnti.cloudfront.net/Images/Manufacturing/growth 1.png"}
                alt={"img"}
                width={"0"}
                height={"0"}
                sizes={"100vw"}
