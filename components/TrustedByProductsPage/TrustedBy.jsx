      ...
      <div className={styles.trustedByMainslide}>
        <Slider {...settings}>
          <div className={styles.trustedByslideDivSection}>
            <div>
              <img src="/Images/TrustedBy/bluenile.png" alt="image" />
            </div>
          </div>

          <div className={styles.trustedByslideDivSection}>
            <div>
              <img src="/Images/TrustedBy/brewdos.png" alt="image" />
            </div>
          </div>
          ...
          <div className={styles.trustedByslideDivSection}>
            <div>
              <img
                src="/Images/TrustedBy/bridgestone.png" alt="image"
              />
            </div>
          </div>
          ...
          <div className={styles.trustedByslideDivSection}>
            <div>
              <img src="/Images/TrustedBy/fiver.png" alt="image" />
            </div>
          </div>

          <div className={styles.trustedByslideDivSection}>
            <div>
              <img src="/Images/TrustedBy/itv.png" alt="image" />
            </div>
          </div>

          <div className={styles.trustedByslideDivSection}>
            <div>
              <img src="/Images/TrustedBy/klarna.png" alt="image" />
            </div>
          </div>

          <div className={styles.trustedByslideDivSection}>
            <div>
              <img src="/Images/TrustedBy/multichoice.png" alt="image" />
            </div>
          </div>

          <div className={styles.trustedByslideDivSection}>
            <div>
              <img src="/Images/TrustedBy/travix.png" alt="image" />
            </div>
          </div>
        </Slider>
      </div>
