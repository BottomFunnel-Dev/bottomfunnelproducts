        ...
        <div className={styles.allindistriescustomerdelightmainboxes}>
            ...
            <div className={styles.allindiacustomerdelightmappingbox}>{customerdelightdata.map((e) => {
                return (
                    ...
                    >
                        <Link href={`${e.link}`} style={{color:"inherit", textDecoration:"none"}}>
                            <div className={styles.customerdelightdatamappingimg}>
                                <img src={e.icon} alt="image" />
                            </div>

                            <div className={styles.customerdelightdatamappingtxt}>
                                <h4>{e.htxt}</h4>
                                <p>{e.stxt}</p>
