...
export default function ReportAndAnalysisReports  () {
    const reportdata=[
        {
            img:"https://d3op2l77j7wnti.cloudfront.net/Images/funnelReportanalysis/Vectors/Group 770717.webp",
        ...
        {
            img:"https://d3op2l77j7wnti.cloudfront.net/Images/funnelReportanalysis/Vectors/Group 770730.webp",
        ...
        {
            img:"https://d3op2l77j7wnti.cloudfront.net/Images/funnelReportanalysis/Vectors/Group 770691.webp",
        ...
        {
            img:"https://d3op2l77j7wnti.cloudfront.net/Images/funnelReportanalysis/Vectors/image 6.webp",
  ...
  return (
    <div className={styles.reportsMain}>
        ...
        <hr style={{border:"2px solid #14944C", width:"40%",backgroundColor:"#14944C", }}></hr>
    </div>
  )
}
