...
export const HelpWidget = () => {
  const helpwidgetdata = [
    {
      image: "/Images/helpdesk/Component 63.webp",
    ...
    {
      image: "/Images/helpdesk/Social-1.webp",
      htxt: "Make it yours",
    ...
    <div className={styles.helpwidgetmainboxes}>
      ...
      <div className={styles.helpwidgetsipportdeskbox}>
        ...
        <div className={styles.helpwidgetsipportdeskboxright}>
          <img src="/Images/helpdesk/Frame.png" alt="helpdesk/Frame.webp" />
        </div>
      </div>
    </div>
  );
