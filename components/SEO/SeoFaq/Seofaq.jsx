    ...
    <div className={styles.seofaqs}>
      ...
      {/* <Accordion flush className={styles._Seofaq1}>
        <Accordion.Item eventKey="0">
          ...
          <Accordion.Body>
            SEO is short form for "search engine optimization," which is a technique used to improve the ranking of a website in search
            engines. This can be done through improving the amount and quality of your website's content, as well as targeted marketing
            efforts that include SEO.
          </Accordion.Body>
        </Accordion.Item>
        <Accordion.Item eventKey="2">
          <Accordion.Header>
            <p className={styles._Seofaq2}>Why is SEO Important?</p>
          </Accordion.Header>
          <Accordion.Body>
            SEO is one the most important aspects of online marketing. It can help you to increase traffic to your website,
            improve brand visibility, and generate leads for your business. By optimizing your website for search engines,
            you can attract more interested visitors who are looking for information about your products or services.
          </Accordion.Body>
        </Accordion.Item>
        <Accordion.Item eventKey="3">
          <Accordion.Header >
            <p className={styles._Seofaq2}>How to hire a professional SEO services company?</p>
          </Accordion.Header>
          <Accordion.Body>
        ...
        <Accordion.Item eventKey="4">
          <Accordion.Header >
            <p className={styles._Seofaq2}>Why should I choose Bottom Funnel for professional SEO services?</p>
          </Accordion.Header>
          <Accordion.Body>
        ...
        <Accordion.Item eventKey="5">
          <Accordion.Header >
            <p className={styles._Seofaq2}>How to get started for my SEO project?</p>
          </Accordion.Header>
          <Accordion.Body>
        ...
        <Accordion.Item eventKey="6">
          <Accordion.Header >
            <p className={styles._Seofaq2}>How is Bottom Funnel is different from other SEO service companies?</p>
          </Accordion.Header>
          <Accordion.Body>
