...
import Enq from "../..https://d3op2l77j7wnti.cloudfront.net/Imagesection/EnquiryNow.jpg";
// import Enq from "../..https://d3op2l77j7wnti.cloudfront.net/Imagesection/EnquiryNow.jpg";
  ...
  return (
    <div className={styles._EnquiryNowMaindiv}>
      <div className={styles._EnquiryNow}>
        <img src="../..https://d3op2l77j7wnti.cloudfront.net/Imagesection/EnquiryNow.jpg" alt="enq.img" />
