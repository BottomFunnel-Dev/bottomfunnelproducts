...
import styles from "./AllFeaturesDrive.module.css";
import Image from "next/image";

export const AllFeaturesDrive = () => {
  return (
    <div className={styles.allFeaturesDriveMainDiv}>
        ...
        <div className={styles.allFeaturesContainer}>
            <div className={styles.allFeaturesContainerBoxes}>
                        ...
                        <div className={styles.allFeaturesBoxes}>
                           <div className={styles.allFeaturesIconsHeading}>
                                ...
                                <div className={styles.allFeaturesImage1}>
                                    <Image
                                        src={"/Images/allFeatures/Rectangle1.webp"}
                                        alt={"image"}
                                        width={"0"}
                                        height={"0"}
                                        sizes={"100vw"}
                        ...
                        <div className={styles.allFeaturesBoxes}>
                           <div className={styles.allFeaturesIconsHeading}>
                                ...
                                <div className={styles.allFeaturesImage4}>
                                    <Image
                                        src={"/Images/allFeatures/Rectangle4.webp"}
                                        alt={"image"}
                                        width={"0"}
                                        height={"0"}
                                        sizes={"100vw"}
                        ...
                        <div className={styles.allFeaturesBoxes}>
                           <div className={styles.allFeaturesIconsHeading}>
                                ...
                                <div className={styles.allFeaturesImage5}>
                                    <Image
                                        src={"/Images/allFeatures/Rectangle7.webp"}
                                        alt={"image"}
                                        width={"0"}
                                        height={"0"}
                                        sizes={"100vw"}
                        ...
                        <div className={styles.allFeaturesBoxes}>
                           <div className={styles.allFeaturesIconsHeading}>
                                ...
                                <div className={styles.allFeaturesImage6}>
                                    <Image
                                        src={"/Images/allFeatures/Rectangle8.webp"}
                                        alt={"image"}
                                        width={"0"}
                                        height={"0"}
                                        sizes={"100vw"}
                        ...
                        <div className={styles.allFeaturesBoxes}>
                           <div className={styles.allFeaturesIconsHeading}>
                                ...
                                <div className={styles.allFeaturesImage7}>
                                    <Image
                                        src={"/Images/allFeatures/Rectangle9.webp"}
                                        alt={"image"}
                                        width={"0"}
                                        height={"0"}
                                        sizes={"100vw"}
                        ...
                        <div className={styles.allFeaturesBoxes}>
                           <div className={styles.allFeaturesIconsHeading}>
                                ...
                                <div className={styles.allFeaturesImage8}>
                                    <Image
                                        src={"/Images/allFeatures/Rectangle10.webp"}
                                        alt={"image"}
                                        width={"0"}
                                        height={"0"}
                                        sizes={"100vw"}
                        ...
                        <div className={styles.allFeaturesBoxes1}>
                            <div className={styles.allFeaturesIconsHeading}>
                                ...
                                <div className={styles.allFeaturesImage9}>
                                    <Image
                                        src={"/Images/allFeatures/Rectangle5.webp"}
                                        alt={"image"}
                                        width={"0"}
                                        height={"0"}
                                        sizes={"100vw"}
                        ...
                        <div className={styles.allFeaturesBoxes1}>
                            <div className={styles.allFeaturesIconsHeading}>
                                ...
                                <div className={styles.allFeaturesImage10}>
                                    <Image
                                        src={"/Images/allFeatures/Rectangle6.webp"}
                                        alt={"image"}
                                        width={"0"}
                                        height={"0"}
                                        sizes={"100vw"}
