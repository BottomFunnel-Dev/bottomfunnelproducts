...
export const OnlinePaymentExclusive = () => {
    ...
    const onlinepaymentexclusivedata = [
        {
            icon: "https://d3op2l77j7wnti.cloudfront.net/Images/onlinepaymentpage/bill 1.png",
        ...
        {
            icon: "https://d3op2l77j7wnti.cloudfront.net/Images/onlinepaymentpage/secure-shield 1.png",
        ...
        {
            icon: "https://d3op2l77j7wnti.cloudfront.net/Images/onlinepaymentpage/operation 1.png",
        ...
        {
            icon: "https://d3op2l77j7wnti.cloudfront.net/Images/onlinepaymentpage/payment-method 1.png",
        ...
        {
            icon: "https://d3op2l77j7wnti.cloudfront.net/Images/onlinepaymentpage/bank 1.png",
            htxt: "ACH & Check 21",
        ...
        {
            icon: "https://d3op2l77j7wnti.cloudfront.net/Images/onlinepaymentpage/security 1.png",
