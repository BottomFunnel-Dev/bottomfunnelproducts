...
export const OnlinePaymentExclusive = () => {
    ...
    const onlinepaymentexclusivedata = [
        {
            icon: "https://bottom-funnel-product.s3.ap-south-1.amazonaws.com/Images/onlinepaymentpage/bill 1.png",
        ...
        {
            icon: "https://bottom-funnel-product.s3.ap-south-1.amazonaws.com/Images/onlinepaymentpage/secure-shield 1.png",
        ...
        {
            icon: "https://bottom-funnel-product.s3.ap-south-1.amazonaws.com/Images/onlinepaymentpage/operation 1.png",
        ...
        {
            icon: "https://bottom-funnel-product.s3.ap-south-1.amazonaws.com/Images/onlinepaymentpage/payment-method 1.png",
        ...
        {
            icon: "https://bottom-funnel-product.s3.ap-south-1.amazonaws.com/Images/onlinepaymentpage/bank 1.png",
            htxt: "ACH & Check 21",
        ...
        {
            icon: "https://bottom-funnel-product.s3.ap-south-1.amazonaws.com/Images/onlinepaymentpage/security 1.png",
