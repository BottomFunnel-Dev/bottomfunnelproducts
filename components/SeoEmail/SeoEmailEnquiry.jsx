...
import styles from './SeoEmailEnquiry.module.css';

export default function SeoEmailEnquiryNow() {
    return (
        <div className={styles.seoEmailEnquiryNowMaindiv}>
            <div className={styles.seoEmailEnquiryNow}>
                <img src="/Images/seoemail.png" alt="images" />
            </div>
