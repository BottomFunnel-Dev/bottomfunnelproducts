            ...
            <div className={styles.GuideToShopFySegmentsOnlyChild}>
                <div className={styles.GuideToShopFySegmentsOnlyChilddivone}>
                    <div>
                        ...
                        <Image
                            src={"https://bottom-funnel-product.s3.ap-south-1.amazonaws.com/Images/GuideToShopFy/icon21.png"}
                            alt={"img"}
                            width={"0"}
                            height={"0"}
                            sizes={"100vw"}
                ...
                <div className={styles.GuideToShopFySegmentsOnlyChilddivtwo}>
                    <div>
                        ...
                        <Image
                            src={"https://bottom-funnel-product.s3.ap-south-1.amazonaws.com/Images/GuideToShopFy/icon22.png"}
                            alt={"img"}
                            width={"0"}
                            height={"0"}
                            sizes={"100vw"}
                ...
                <div className={styles.GuideToShopFySegmentsOnlyChilddivthree} >
                    <div>
                        ...
                        <Image
                            src={"https://bottom-funnel-product.s3.ap-south-1.amazonaws.com/Images/GuideToShopFy/icon23.png"}
                            alt={"img"}
                            width={"0"}
                            height={"0"}
                            sizes={"100vw"}
