    ...
    <div className={style.TheSolutionmaindiv}>
      ...
      <div className={style.TheSolutiondiv}>
        ...
        <div className={style.TheSolutioncontaindiv}>
          ...
          <p> Bottom Funnel Sales keeps your sales teams in-the-know about the entire contact lifecycle, from click to close,
            on a single platform. You can now identify which source brings you the best quality leads, maximize your efforts,
            and attribute your ROI to the right source every time.
          </p>
        </div>
      </div>
    </div>
