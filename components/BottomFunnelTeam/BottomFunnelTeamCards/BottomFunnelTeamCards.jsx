...
export const BottomFunnelTeamCards = () => {
     ...
     <div className={styles.BottomFunnelTeamCardsmaindiv}>
        ...
        <div className={styles.BottomFunnelTeamCardsinnerdiv}>
            <div className={styles.BottomFunnelTeamCardsinnerdivcards}>
                ...
                <Image
  src={"/Images/bottomfunnelteamsphotos/recruit.webp"}
  alt={"image"}
  width={"0"}
  height={"0"}
  sizes={"100vw"}
  ...
  />
            ...
            <div className={styles.BottomFunnelTeamCardsinnerdivcards}>
                <div className={styles.BottomFunnelTeamCardsinnerdivimage}>
                <Image
  src={"/Images/bottomfunnelteamsphotos/database.webp"}
  alt={"image"}
  width={"0"}
  height={"0"}
  sizes={"100vw"}
  ...
  />
            ...
            <div className={styles.BottomFunnelTeamCardsinnerdivcards}>
                <div className={styles.BottomFunnelTeamCardsinnerdivimage}>
                <Image
  src={"/Images/bottomfunnelteamsphotos/administration.webp"}
  alt={"image"}
  width={"0"}
  height={"0"}
  sizes={"100vw"}
  ...
  />
            ...
            <div className={styles.BottomFunnelTeamCardsinnerdivcards}>
                <div className={styles.BottomFunnelTeamCardsinnerdivimage}>
                <Image
  src={"/Images/bottomfunnelteamsphotos/payroll.webp"}
  alt={"image"}
  width={"0"}
  height={"0"}
  sizes={"100vw"}
  ...
  />
        ...
        <div className={styles.BottomFunnelTeamCardsinnerdiv}>
            <div className={styles.BottomFunnelTeamCardsinnerdivcards}>
                <div className={styles.BottomFunnelTeamCardsinnerdivimage}>
                <Image
  src={"/Images/bottomfunnelteamsphotos/appraisal.webp"}
  alt={"image"}
  width={"0"}
  height={"0"}
  sizes={"100vw"}
  ...
  />
            ...
            <div className={styles.BottomFunnelTeamCardsinnerdivcards}>
                <div className={styles.BottomFunnelTeamCardsinnerdivimage}>
                <Image
  src={"/Images/bottomfunnelteamsphotos/attendance.webp"}
  alt={"image"}
  width={"0"}
  height={"0"}
  sizes={"100vw"}
  ...
  />
            ...
            <div className={styles.BottomFunnelTeamCardsinnerdivcards}>
                <div className={styles.BottomFunnelTeamCardsinnerdivimage}>
                <Image
  src={"/Images/bottomfunnelteamsphotos/hr report.webp"}
  alt={"image"}
  width={"0"}
  height={"0"}
  sizes={"100vw"}
  ...
  />
            ...
            <div className={styles.BottomFunnelTeamCardsinnerdivcards}>
                <div className={styles.BottomFunnelTeamCardsinnerdivimage}>
                <Image
  src={"/Images/bottomfunnelteamsphotos/feature.webp"}
  alt={"image"}
  width={"0"}
  height={"0"}
  sizes={"100vw"}
