            ...
            <div className={styles.MarketPlaceFeatureParent}>
                ...
                <div className={styles.MarketPlaceFeatureChild}>
                    <div>
                        ...
                        /></div>
                        <h3>Help Desk Migration | Import to
                            Freshdesk</h3>
                        <p>Help Desk Migration is an automated SaaS
                            that imports tickets and other related data
                            to Freshdesk</p>
                    </div>
                    <div>
                        <div className={styles.MarketPlaceFeatureimg}> <Image
                        ...
                        <p>Ever wished your reply would open a ticket
                            on autopilot?</p>
                    </div>
                    <div>
                        <div className={styles.MarketPlaceFeatureimg}> <Image
            ...
            <div className={styles.MarketPlaceFeatureParent}>
                ...
                <div className={styles.MarketPlaceFeatureChild}>
                    ...
                    <div>
                        ...
                        <p>Use Textline to send and respond to text
                            messages directly from your customer
                            support desk</p>
                    </div>
                    <div>
                        <div className={styles.MarketPlaceFeatureimg}> <Image
                    ...
                    <div>
                        <div className={styles.MarketPlaceFeatureimg}> <Image
                            ...
                            style={{ width: "100%", height: "100%" }}
                        /></div>
                        <h3>Freshdesk on PowerBI
                        </h3>
                        <p>Analytical PowerBI add-on to Freshdesk
                            Application</p>
                    </div>
