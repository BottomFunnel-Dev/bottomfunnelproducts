  ...
  return (
    <div className={styles.ngoWhyUsMainDiv}>
      <div className={styles.ngoWhyUsImageDiv}>
        <Image
          src={"/Images/ngoandnonProfits/Group11.webp"}
          alt={"img"}
          width={"0"}
          height={"0"}
          sizes={"100vw"}
            ...
            <div className={styles.ngoWhyusContainer}>
               <div className={styles.ngoWhyusDataBox}>
                   <div className={styles.ngoWhyusData}>
                      <div className={styles.ngoWhyDataImage}>
                         <Image
                            src={"/Images/ngoandnonProfits/Group1.webp"}
                            alt={"img"}
                            width={"0"}
                            height={"0"}
                            sizes={"100vw"}
                   ...
                   <div className={styles.ngoWhyusData}>
                      <div className={styles.ngoWhyDataImage}>
                         <Image
                            src={"/Images/ngoandnonProfits/Group2.webp"}
                            alt={"img"}
                            width={"0"}
                            height={"0"}
                            sizes={"100vw"}
                   ...
                   <div className={styles.ngoWhyusData}>
                      <div className={styles.ngoWhyDataImage}>
                         <Image
                            src={"/Images/ngoandnonProfits/Group3.webp"}
                            alt={"img"}
                            width={"0"}
                            height={"0"}
                            sizes={"100vw"}
               ...
               <div className={styles.ngoWhyusDataBox1}>
                   <div className={styles.ngoWhyusData1}>
                      <div className={styles.ngoWhyDataImage}>
                         <Image
                            src={"/Images/ngoandnonProfits/Group4.webp"}
                            alt={"img"}
                            width={"0"}
                            height={"0"}
                            sizes={"100vw"}
                   ...
                   <div className={styles.ngoWhyusData1}>
                      <div className={styles.ngoWhyDataImage}>
                         <Image
                            src={"/Images/ngoandnonProfits/Group5.webp"}
                            alt={"img"}
                            width={"0"}
                            height={"0"}
                            sizes={"100vw"}
