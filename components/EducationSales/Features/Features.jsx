...
export const Features = () => {
  return (
   ...
   <div className={styles.Featuresmaindiv}>
    ...
    <Image
                        src={"https://d3op2l77j7wnti.cloudfront.net/Images/Educationsales/Education 1.webp"}
                        alt={"img"}
                        width={"0"}
                        height={"0"}
                        sizes={"100vw"}
   ...
   <div className={styles.Featuresmaindiv}>
    ...
    <div className={styles.Featuresmaindivcontentimage}>
    <Image
                        src={"https://d3op2l77j7wnti.cloudfront.net/Images/Educationsales/Education 2.webp"}
                        alt={"img"}
                        width={"0"}
                        height={"0"}
                        sizes={"100vw"}
   ...
   <div className={styles.Featuresmaindiv}>
    ...
    <div className={styles.Featuresmaindivcontentimage}>
    <Image
                        src={"https://d3op2l77j7wnti.cloudfront.net/Images/Educationsales/Education 3.webp"}
                        alt={"img"}
                        width={"0"}
                        height={"0"}
                        sizes={"100vw"}
...
With sales sequences in a course management software like Freshsales, you can</p>
    ...
    <div className={styles.Featuresmaindivcontentimage}>
    <Image
                        src={"https://d3op2l77j7wnti.cloudfront.net/Images/Educationsales/Education 4.webp"}
                        alt={"img"}
                        width={"0"}
                        height={"0"}
                        sizes={"100vw"}
   ...
   <div className={styles.Featuresmaindiv}>
    ...
    <div className={styles.Featuresmaindivcontentimage}>
    <Image
                        src={"https://d3op2l77j7wnti.cloudfront.net/Images/Educationsales/Education 5.webp"}
                        alt={"img"}
                        width={"0"}
                        height={"0"}
                        sizes={"100vw"}
